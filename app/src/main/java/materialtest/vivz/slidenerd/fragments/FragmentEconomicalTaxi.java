...
import materialtest.vivz.slidenerd.adapters.TaxiServicesAdapterEcomonical;
 ...
 * Use the {@link FragmentEconomicalTaxi#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentEconomicalTaxi extends Fragment implements SortListener, UpcomingMoviesLoadedListener {
    ...
    private TaxiServicesAdapterEcomonical mAdapter;
    ...
    public static List<StoreDetailsTaxiServices> listArray1;

    int limit;
    String taxiType;

    public FragmentEconomicalTaxi() {
    ...
    public static FragmentEconomicalTaxi newInstance(String param1, String param2) {
        FragmentEconomicalTaxi fragment = new FragmentEconomicalTaxi();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        StoreDetailsTaxiServices storeDetailsTaxiServices = new StoreDetailsTaxiServices();
            ...
            listArray1.add(storeDetailsTaxiServices);
        ...
        mAdapter = new TaxiServicesAdapterEcomonical(listArray1,getActivity());
