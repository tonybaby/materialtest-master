 ...
 * Use the {@link FragmentCoachesTaxi#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentCoachesTaxi extends Fragment implements SortListener, UpcomingMoviesLoadedListener {
    ...
    public static List<StoreDetailsTaxiServices> listArray3;

    int limit;
    String taxiType;

    public FragmentCoachesTaxi() {
    ...
    public static FragmentCoachesTaxi newInstance(String param1, String param2) {
        FragmentCoachesTaxi fragment = new FragmentCoachesTaxi();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(int i =0;i<10;i++) {
            ...
            listArray3.add(storeDetailsTaxiServices);
        }
        //mAdapter.notifyDataSetChanged();
        ...
        mAdapter = new TaxiServicesAdapter(listArray3,getActivity());
